    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="info">
                ...
                <div>
                    <p>Phone</p>
                    <h6>{{ isset($data) ? '(+62) ' . $data->no_tlp : 'Tidak Ada Nomor Telpon' }}</h6>
                </div>
            </div>
            <h6>Experiences</h6>
            <div class="info">
                @foreach ($experiences as $item)
                    <div>
                        <p>{{ isset($item->posisi) ? $item->posisi : 'Tidak ada pengalaman' }}</p>
                        <h6>{{ isset($item->nama_perusahaan) ? $item->nama_perusahaan : 'Tidak ada perusahaan' }}</h6>
                        <p>{{ isset($item->job) ? $item->job : 'Tidak ada descriptions' }}</p>
                    </div>
                @endforeach
                <div>
                </div>
