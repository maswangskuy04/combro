        ...
        <div class="card-body p-5">
            ...
            <form action="{{ route('profiles.update', $profiles->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="picture" id="picture" class="form-control" value="{{ $profiles->picture }}">
                    <img src="{{ asset('storage/image/' . $profiles->picture) }}" alt="">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control">{{ $profiles->alamat }}</textarea>
                </div>
                <div class="mb-3">
                    <label for="">No Telp</label>
                    <input type="number" name="no_tlp" id="no_tlp" class="form-control"
                        value="{{ $profiles->no_tlp }}">
                </div>
                <div class="mb-3">
                    <label for="">Email</label>
                    <input type="email" name="email" id="email" class="form-control" value="{{ $profiles->email }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" name="description" id="description" cols="30" rows="10" class="form-control">{{ $profiles->description }}</textarea>
                </div>
                <div class="mb-3">
