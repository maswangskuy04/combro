    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
                    src="{{ asset('storage/image/' . $profiles->picture) }}" alt="..." /></span>
        </a>
    ...
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                <h1 class="mb-0">
                    @php
                        $namalengkap = $profiles->nama_lengkap;
                ...
                <p class="lead mb-5">{{ $profiles->description }}</p>
                <div class="social-icons">
                    <a class="social-icon" href="{{ $profiles->linkedin }}"><i class="fab fa-linkedin-in"></i></a>
                    <a class="social-icon" href="{{ $profiles->github }}"><i class="fab fa-github"></i></a>
                    <a class="social-icon" href="{{ $profiles->twitter }}"><i class="fab fa-twitter"></i></a>
                    <a class="social-icon" href="{{ $profiles->facebook }}"><i class="fab fa-facebook-f"></i></a>
                </div>
            </div>
        </section>
        <hr class="m-0" />
            ...
            <div class="resume-section-content">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
                        <h3 class="mb-0">{{ $experiences->posisi }}</h3>
                        <div class="subheading mb-3">{{ $experiences->nama_perusahaan }}</div>
                        <p>{{ $experiences->job }}</p>
                    </div>
                    <div class="flex-shrink-0"><span class="text-primary">{{ $experiences->periode }}</span></div>
                </div>
                <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                    <div class="flex-grow-1">
